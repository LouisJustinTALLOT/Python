...
Noms : arête, frite, gobelet, jambon, os, poulet, purée, radis, restaurant, sole
...
Verbes : avancer, briller, dîner, grandir, mettre du temps, suivre , retarder

Adjectifs : aîné, jeune, lent, patient, rapide, sombre, vieux

Adverbes : aujourd’hui, bientôt, d’abord, demain, hier, maintenant, puis, tout de suite, en avance , en retard
...
Noms : adulte, album, amour, baiser, bavoir, biberon, bisou, caprice, cimetière, cousin, cousine, crèche, fils, frère, grand-parent, homme, femme, jumeau, maman, mari, mariage, mère, papa, parent, père, petit-enfant, petit-fils, petite-fille, rasoir, sœur
...
ch=ch.replace('\n',' ')
ch=ch.replace('Noms :','')
ch=ch.replace('Verbes :','')
ch=ch.replace('Adjectifs :','')
ch=ch.replace('Prépositions :','')
ch=ch.replace('Adverbes :','')
